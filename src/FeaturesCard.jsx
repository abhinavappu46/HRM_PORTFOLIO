        ...
        <div id='MainDiv'>
            <div className='Card'>
                <div className='VideoCard'>
                    <video className="Video" src="/video/EmployeeDash.mp4" alt='video view' autoPlay muted loop />
                </div>
                <div className='FeaturesCard'>
                    <center><h2>Employee Dasboard</h2></center>
                    <p className='Ptag'>• Submit and track employee requests </p>
                    <p className='Ptag'>• Monitor daily and monthly attendance reports</p>
                    <p className='Ptag'>• View request history and document updates in one place</p>
                    <p className="Ptag">• Get a personalized dashboard with employee activity insights</p>
                </div>
            </div>
            <div className='Card'>
                <div className='VideoCard'>
